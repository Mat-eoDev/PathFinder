...
@dso_cache = dso_local local_unnamed_addr global [510 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 99966311, ; hash 0x5f55d67, from name: aot-PathFinder.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 804308880, ; hash 0x2ff0c790, from name: libaot-PathFinder.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PathFinder.dll.so
		ptr null; void* handle (0x0)
	}, ; 87
	...
	%struct.DSOCacheEntry {
		i64 1032732303, ; hash 0x3d8e3e8f, from name: PathFinder.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PathFinder.dll.so
		ptr null; void* handle (0x0)
	}, ; 119
	...
	%struct.DSOCacheEntry {
		i64 1979850831, ; hash 0x7602204f, from name: libaot-PathFinder
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PathFinder.dll.so
		ptr null; void* handle (0x0)
	}, ; 228
	...
	%struct.DSOCacheEntry {
		i64 2020220595, ; hash 0x786a1eb3, from name: aot-PathFinder
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PathFinder.dll.so
		ptr null; void* handle (0x0)
	}, ; 232
	...
	%struct.DSOCacheEntry {
		i64 3946980276, ; hash 0xeb4223b4, from name: PathFinder
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PathFinder.dll.so
		ptr null; void* handle (0x0)
	}, ; 470
