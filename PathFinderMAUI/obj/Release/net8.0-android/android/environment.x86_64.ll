...
@dso_cache = dso_local local_unnamed_addr global [510 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.76_name, ; name: libaot-System.Text.Encodings.Web.dll.so
		ptr null; void* handle (0x0)
	}, ; 56
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.60_name, ; name: libaot-System.IO.Pipes.dll.so
		ptr null; void* handle (0x0)
	}, ; 114
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.57_name, ; name: libaot-System.Diagnostics.Process.dll.so
		ptr null; void* handle (0x0)
	}, ; 120
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 7449167918065689471, ; hash 0x6760c2c10c8aa37f, from name: PathFinder
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PathFinder.dll.so
		ptr null; void* handle (0x0)
	}, ; 176
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.77_name, ; name: libaot-System.Text.Json.dll.so
		ptr null; void* handle (0x0)
	}, ; 190
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 10116486020267855407, ; hash 0x8c64fa6f9d454e2f, from name: libaot-PathFinder.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PathFinder.dll.so
		ptr null; void* handle (0x0)
	}, ; 270
	...
	%struct.DSOCacheEntry {
		i64 12885395661002632868, ; hash 0xb2d21f157c6beea4, from name: libaot-PathFinder
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PathFinder.dll.so
		ptr null; void* handle (0x0)
	}, ; 353
	...
	%struct.DSOCacheEntry {
		i64 16005597563468836422, ; hash 0xde1f4e2ec46aee46, from name: aot-PathFinder.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PathFinder.dll.so
		ptr null; void* handle (0x0)
	}, ; 443
	...
	%struct.DSOCacheEntry {
		i64 16041808857450173748, ; hash 0xde9ff429a7085534, from name: aot-PathFinder
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PathFinder.dll.so
		ptr null; void* handle (0x0)
	}, ; 445
	...
	%struct.DSOCacheEntry {
		i64 16618162049400759667, ; hash 0xe69f92564e68e573, from name: PathFinder.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PathFinder.dll.so
		ptr null; void* handle (0x0)
	}, ; 459
...
@.env.3 = private unnamed_addr constant [37 x i8] c"c4b3f328-a43c-4727-826b-4cae074d7123\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [27 x i8] c"com.companyname.pathfinder\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [25 x i8] c"libaot-PathFinder.dll.so\00", align 16
...
@.DSOCacheEntry.57_name = private unnamed_addr constant [41 x i8] c"libaot-System.Diagnostics.Process.dll.so\00", align 16
...
@.DSOCacheEntry.60_name = private unnamed_addr constant [30 x i8] c"libaot-System.IO.Pipes.dll.so\00", align 16
...
@.DSOCacheEntry.76_name = private unnamed_addr constant [40 x i8] c"libaot-System.Text.Encodings.Web.dll.so\00", align 16
@.DSOCacheEntry.77_name = private unnamed_addr constant [31 x i8] c"libaot-System.Text.Json.dll.so\00", align 16
